...
const PACKAGES = {
  "linux-x64": "@diffler/linux-x64",
  "linux-arm64": "@diffler/linux-arm64",
  "darwin-x64": "@diffler/darwin-x64",
  "darwin-arm64": "@diffler/darwin-arm64",
  "win32-x64": "@diffler/win32-x64",
  "win32-arm64": "@diffler/win32-arm64",
};
...
function resolveBinary() {
  ...
  try {
    ...
    console.error(
      "Reinstall with optional dependencies enabled: npm install -g diffler"
    );
    process.exit(1);
  }
}
